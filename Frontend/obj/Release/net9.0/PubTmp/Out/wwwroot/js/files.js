async function downloadWord(journalId, groupNumber, hasPageNumeration) {
    const response = await fetch(`https://localhost:7059/api/journal/downloadword/${journalId}?hasPageNumeration=` + hasPageNumeration, {
        method: 'GET',
    });
